...
def main():
    ...
    ap.add_argument('--encode_batch_size',type=int,default=2048); ap.add_argument('--wandb',type=lambda x: str(x).lower() in ['1','true','yes'],default=False); ap.add_argument('--dry_run',action='store_true'); ap.add_argument('--out',default='')
